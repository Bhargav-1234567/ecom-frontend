...
const Products = () => {
  ...
  const allProducts = [
    ...
    },
    {
      ...
      description:
        "Comfortable cotton t-shirt perfect for summer wear. Available in multiple colors.",
      category: "Clothing",
      discount: 0,
      isFavorite: true,
    },
    {
      ...
      description:
        "HD security camera with night vision and mobile app integration.",
      category: "Electronics",
      discount: 25,
      isFavorite: false,
    },
  ...
  const filteredProducts = allProducts.filter((product) => {
    ...
    if (
      filters.searchTitle &&
      !product.title.toLowerCase().includes(filters.searchTitle.toLowerCase())
    ) {
      return false;
    }
    ...
    // Discount filter
    if (
      filters.discountAmount > 0 &&
      product.discount < filters.discountAmount
    ) {
      return false;
    }
